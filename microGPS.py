...
class MicropyGPS(object):
    ...
    def gprmc(self):
        ...
        try:
            ...
            if utc_string:  # Possible timestamp found
                hours = (int(utc_string[:2]) + self.local_offset) % 24
        ...
        if self.gps_segments[2] == 'A':  # Data from Receiver is Valid/Has Fix
            ...
            try:
                ...
                lat_degs = int(l_string[:2])
                lat_mins = float(l_string[2:])
                lat_hemi = self.gps_segments[4]

                # Longitude
                l_string = self.gps_segments[5]
                lon_degs = int(l_string[:3])
    ...
    def gpgsa(self):
        ...
        for sats in range(12):
            ...
            if not sat_number_str:
                break

            try:
                sats_used.append(int(sat_number_str))
            except ValueError:
                return False
        # PDOP,HDOP,VDOP
        try:
        ...
        if 10 <= ascii_char <= 126:
            ...
            if new_char == '$':
                ...
                # Store All Other printable character and check CRC when ready
                    ...
                    if not self.process_crc and len(self.gps_segments[self.active_segment]) == 2:
                        try:
                ...
                if valid_sentence:
                    ...
                    if self.gps_segments[0] in self.supported_sentences and self.supported_sentences[self.gps_segments[0]](self):
    ...
    def latitude_string(self):
        ...
        if self.coord_format == 'dd':
            ...
            lat_string = f'{str(formatted_latitude[0])}° {str(self._latitude[2])}'
        elif self.coord_format == 'dms':
            formatted_latitude = self.latitude
    ...
    def longitude_string(self):
        ...
        if self.coord_format == 'dd':
            ...
            lon_string = f'{str(formatted_longitude[0])}° {str(self._longitude[2])}'
        elif self.coord_format == 'dms':
            formatted_longitude = self.longitude
    ...
    def speed_string(self, unit='kph'):
        ...
        if unit == 'knot':
            ...
            speed_string = f'{str(self.speed[1])} mph'
